...
export const ANSWERS_WITH_A_NAME = [
  'האדם נשאל זה עתה מה שמו. האם ההודעה שלפניך היא שם של אדם?',
  '„ליבי”, „כהן”, „קוראים לי דנה לוי” — כן.',
  'שאלה, בקשה, ברכה או כל משפט אחר — לא, גם אם אין בו סימן שאלה.',
  '„באיזה עיר”, „כמה עולה”, „רק בשדה” — לא.',
].join('\n');
