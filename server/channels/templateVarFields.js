...
export function resolveTemplateFieldValue(fieldId, parent = null, student = null) {
  ...
  switch (fieldId) {
    ...
    case 'mailing_preferences': {
      // Kept inline to avoid making every template helper depend on the bot.
      // The sending path supplies the signed URL as an override when this field
      // is present; this fallback keeps template previews readable.
      return 'קישור אישי להעדפות הדיוור';
    }
    default:
