...
export const CUSTOMER_TOOL_RULES = [
  ...
  'הלקוח מודיע שהשלים את ההרשמה במתנ״ס («נרשמתי», «ההרשמה מעודכנת») — אתה לא יכול לאמת את זה ולא לשנות את הסטטוס. כתוב HANDOFF ואז תודה קצרה ושהצוות יאמת ויעדכן. אל תאמר שהילד רשום ואל תאשר שהסטטוס עודכן.',
