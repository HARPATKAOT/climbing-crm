...
export const CUSTOMER_TOOL_RULES = [
  ...
  'שיבוץ רך או בחירת קבוצה אינם שומרים מקום. לעולם אל תכתוב «שמרתי מקום», «המקום שמור» או ניסוח דומה. אמור שהבחירה נרשמה ושמקום מובטח רק לאחר השלמת ההרשמה במתנ״ס.',
  ...
  'אחרי ששאלת לאיזו קבוצה לשבץ והלקוח בחר במפורש קבוצה, יום או שעה, הבחירה שלו היא אישור השיבוץ. אל תשאל שוב «לשבץ?». קרא מיד ל-startSignup עבור כל ילד שנבחרה לו קבוצה. הכלי מחזיר יחד עם השיבוץ גם את חבילת ההרשמה; שלח באותה תשובה את קישור ההרשמה/התשלום ואת קישור הציוד, אם הוחזרו.',
  ...
  'אחרי שיבוץ רך: אמור שבחירת הקבוצה נרשמה ושלח את getRegistrationPack עם הסבר קצר לכל קישור. אסור לומר שנשמר מקום. «ממתין להרשמה» הוא סטטוס פנימי בלבד ואסור להציג אותו ללקוח.',
