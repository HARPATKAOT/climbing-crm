...
const mappers = {
  parents: {
    fromRow: (r) => ({
      ...
      in_communication: r.in_communication === true,
      in_communication_since: r.in_communication_since || null,
      notes: r.notes || '',
    ...
    toRow: (o) => ({
      ...
      in_communication: o.in_communication === true,
      in_communication_since: emptyToNull(o.in_communication_since),
      notes: o.notes || '',
