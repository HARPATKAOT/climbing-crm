...
const ACTIVITIES = [
  ...
  },
  {
    ...
    activityPhrase: 'יציאה או טיול טיפוס בשטח',
    // Everything the wall has, plus what only the outdoors adds: rope descent,
    // terrain, weather, travel, and being far from help.
    riskClause: 'ידוע לי כי יציאת טיפוס בשטח — לרבות טיפוס, גלישה על חבל (סנפלינג) והליכה בשטח פתוח — היא פעילות אתגרית הכרוכה מטבעה בסיכון לפגיעה גופנית, לרבות נפילה, החלקה, התדרדרות אבנים, פגיעה מציוד ומאמץ יתר. ידוע לי כי ליציאה לשטח נלווים סיכונים נוספים שאינם קיימים במתקן סגור — תנאי מזג אוויר ושטח, בעלי חיים, הנסיעה אל אתר הפעילות וממנו, וריחוק ממענה רפואי מיידי. הסיכון קיים גם בהקפדה מלאה על הוראות הבטיחות.',
    riskBullet: 'יציאה לשטח כוללת טיפוס וגלישה על חבל, ומוסיפה סיכוני שטח, מזג אוויר, נסיעה וריחוק מעזרה רפואית.',
    safety: [
      ...
      safety('s4', 'טיפוס וגלישה על חבל יתאפשרו רק למי שקיבל/ה תדריך מסודר, ורק בהשגחת מדריך'),
      safety('s5', 'אין לגעת בציוד, בחבלים או בעיגונים ללא הוראת מדריך'),
      safety('s6', 'יש להצטייד במים ולדווח מיד על תשישות, סחרחורת או תחושה לא טובה'),
      safety('s7', 'ידוע לי כי הצוות רשאי לשנות או לבטל את מסלול הפעילות משיקולי בטיחות ומזג אוויר'),
    ],
  },
];
