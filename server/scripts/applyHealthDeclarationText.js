...
const ACTIVITIES = [
  ...
  },
  {
    ...
    nature: [
      ...
      '• נפילה מגובה — עלולה לגרום לפציעה חמורה, נכות או מוות',
      '• החלקה ונפילה — על שטח לא ישר, סלעים רטובים או תלולים',
      '• פגיעה מאבנים נושרות או ציוד — ממשתתפים אחרים או מהשטח עצמו',
      '• מכת חום והתייבשות — בפעילות ממושכת בשמש ובחום',
      '• היפותרמיה — בתנאי קור, רטיבות או רוח',
      '• ריחוק ממענה רפואי מיידי',
      'סיכונים אלו קיימים גם בהקפדה מלאה על כללי הבטיחות.',
    ].join('\n\n'),
