...
export const FORM_SHORT = 'טופס ההשתתפות';

/** מה שאומרים כששולחים אותו בפעם הראשונה — הרשימה המלאה. */
export const FORM_FULL = 'טופס ההשתתפות — פרטי המשתתף, הצהרת בריאות והסרת אחריות';

/** מה שאומרים על טופס שכבר נחתם. */
export const FORM_SIGNED = 'טופס ההשתתפות החתום';
