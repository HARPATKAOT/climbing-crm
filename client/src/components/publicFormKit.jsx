...
export function EventStyles() {
  return <style>{`
    ...
    .event-detail-block{display:grid;gap:3px;margin:0 0 10px}.event-detail-block strong{display:flex;align-items:center;gap:7px;font-size:13px;color:#fff}.event-detail-block span{white-space:pre-wrap;color:#cbd5e1;font-size:13.5px;line-height:1.55}.event-hint{color:#94a3b8;font-size:13px;line-height:1.45;margin:0 0 12px}.event-lists{display:flex;flex-direction:column;gap:4px;margin-bottom:8px}
