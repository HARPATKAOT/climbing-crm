...
export function EventStyles() {
  return <style>{`
    ...
    /* הכותרת נבלעה בטקסט שמעליה ושמתחתיה — היא צריכה אוויר משני צדדיה כדי
       לקרוא כתחילת חלק חדש ולא כשורה מודגשת בתוך פסקה. */
    .event-detail-block{display:grid;gap:9px;margin:0 0 26px}.event-detail-block strong{display:flex;align-items:center;gap:8px;font-size:14px;color:#fff}.event-detail-block span{white-space:pre-wrap;color:#cbd5e1;font-size:13.5px;line-height:1.65}/* בחירת ימים בקייטנה — אסימון לכל יום, ריבוי בחירה. */.event-day-picker{margin:10px 0 14px;padding:12px;border-radius:12px;border:1px solid rgba(255,255,255,.1);background:rgba(0,0,0,.16)}.event-day-toggle{display:flex;align-items:center;gap:9px;font-size:14px;color:#e2e8f0;cursor:pointer}.event-day-toggle input{min-width:18px;min-height:18px}.event-day-chips{display:flex;flex-wrap:wrap;gap:7px;margin-top:11px}.event-day-chip{padding:8px 13px;border-radius:999px;font:inherit;font-size:13px;font-weight:700;cursor:pointer;border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.05);color:#cbd5e1;transition:all .14s ease}.event-day-chip:hover{border-color:rgba(255,255,255,.3)}.event-day-chip.is-on{border-color:var(--form-accent-solid,#38bdf8);background:var(--form-accent-soft-strong,rgba(56,189,248,.18));color:var(--form-accent-text,#7dd3fc)}.event-hint{color:#94a3b8;font-size:13px;line-height:1.45;margin:0 0 12px}.event-lists{display:flex;flex-direction:column;gap:4px;margin-bottom:8px}
    /* תנאי הביטול בדף האירוע: שורה לכל מדרגה — מתי מימין, ומתחתיו מה קורה אז,
       צבוע לפי כמה הבשורה טובה. אותם צבעים שהדף כבר מדבר בהם. */
    .event-policy{padding:16px;margin:12px 0;border:1px solid rgba(255,255,255,.1);border-radius:14px;background:rgba(0,0,0,.16)}
    .event-policy h3{display:flex;align-items:center;gap:7px;margin:0 0 4px;font-size:14px;color:#fff}.event-policy h3 svg{color:var(--form-accent-text,#fdba74)}
    .event-policy-row{display:flex;gap:11px;align-items:flex-start;padding:10px 0}.event-policy-row+.event-policy-row{border-top:1px solid rgba(255,255,255,.07)}
    .event-policy-dot{min-width:9px;height:9px;border-radius:999px;margin-top:5px}.event-policy-dot.is-good{background:#34d399;box-shadow:0 0 8px rgba(52,211,153,.5)}.event-policy-dot.is-mid{background:#fbbf24;box-shadow:0 0 8px rgba(251,191,36,.45)}.event-policy-dot.is-bad{background:#f87171;box-shadow:0 0 8px rgba(248,113,113,.45)}
    .event-policy-when{color:#e2e8f0;font-size:13.5px;font-weight:700;line-height:1.4}
    .event-policy-what{font-size:13px;line-height:1.4;margin-top:2px}.event-policy-what.is-good{color:#6ee7b7}.event-policy-what.is-mid{color:#fcd34d}.event-policy-what.is-bad{color:#fca5a5}
    .event-policy-note{margin:10px 0 0;padding-top:10px;border-top:1px solid rgba(255,255,255,.07);color:#94a3b8;font-size:12.5px;line-height:1.5;white-space:pre-wrap}
    .event-waiver{white-space:pre-wrap;max-height:200px;overflow:auto;padding:14px;border-radius:12px;background:#0b1220;color:#cbd5e1;line-height:1.55;font-size:13px}
    /* המשפט שאומר על איזו יציאה החתימה ניתנת — נבדל מהנוסח הכללי שמעליו. */
    .event-waiver-activity{margin-top:12px;padding:12px 14px;border-radius:12px;background:var(--form-accent-soft,rgba(249,115,22,.1));border:1px solid var(--form-accent-border,rgba(249,115,22,.35));color:#e2e8f0;line-height:1.6;font-size:13.5px;font-weight:700}.event-signature{width:100%;height:150px;background:#111827;border:1px solid rgba(255,255,255,.2);border-radius:12px;touch-action:none}.event-label{color:#cbd5e1;margin-bottom:7px}
