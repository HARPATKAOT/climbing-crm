 ...
 * השיחה.
 *
 * מה שסוגר את השורה הוא לחיצה על „סיום הטיפול” בכרטיס הלקוח, שרושמת
 * `communication_handled_at`. תשובה ללקוח לבדה לא סוגרת: „אני בודק ואחזור
 * אליך” הוא אמצע הטיפול, לא סופו. הסייג היחיד הוא זמן — העברה בת שבועיים
 * ומעלה היא היסטוריה ולא תור.
 */
